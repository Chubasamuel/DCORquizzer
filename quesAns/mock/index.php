...
<div id="ovAll" style="display:none"> 
...
<font style="font-weight:bold">INSTRUCTIONS:</font><br ><br />
 ...
 (ii) Any malpractice renders the participant 
      scoring zero. <br /><br />
(iii) Click the icon beside an option to select it as your choice.<br /><br />
(iv) After clicking the submit button,the test is marked.<br />  Options marked<font style="color:#f90039"> red </font> mean that you<br /> selected the option but it was the wrong option.<br />  Options marked <font style="color:#33dbcc">green </font>are correct;<br /> while for questions you did not answer,<br /> the correct options are marked in <font style="color:#3fc9f9">blue</font>.
<br /><br /> <span style="white-space:pre"><span id="instructionV">(v) When in doubt about any option,
 please <b>leave blank</b> because wrong<br /> answer attracts negative marking.</span></span><br /><br />
<style>
body{position:absolute; }
</style>
<?php
$file_ques=fopen("./mock.ques.txt","r");

echo(fread($file_ques,filesize("./mock.ques.txt")));
fclose($file_ques);
...
$file_ans=fopen("./mock.ans.txt","r");
echo(fread($file_ans,filesize("./mock.ans.txt")));
fclose($file_ans);
